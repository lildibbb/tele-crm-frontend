...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="border-none mt-4 mb-4 ml-2 h-[calc(100svh-2rem)] [&>[data-sidebar=sidebar]]:rounded-xl [&>[data-sidebar=sidebar]]:bg-base [&>[data-sidebar=sidebar]]:border-none [&>[data-sidebar=sidebar]]:shadow-[4px_0_24px_rgba(0,0,0,0.4),1px_0_4px_rgba(0,0,0,0.25)] z-40 group/app-sidebar"
    >
