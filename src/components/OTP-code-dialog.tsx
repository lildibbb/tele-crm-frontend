            ...
            <DialogDescription className="sm:text-center">
              {hasGuessed ? (
                <span>
                  ...
                  <strong>exa**le@gmail.com</strong> has been verified
                </span>
              ) : (
                <span>
                  We have sent a verification code to{" "}
                  <strong>exa**le@gmail.com</strong>. Please check your inbox
                  and input the code below to activate your account. Try{" "}
                  {CORRECT_CODE}
                </span>
              )}
            </DialogDescription>
