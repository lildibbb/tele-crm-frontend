...
const ROLE_BADGE: Record<UserRole, string> = {
  SUPERADMIN:
    "text-[10px] px-2 py-0.5 rounded font-semibold bg-amber-500/15 text-amber-600 dark:text-amber-400 ring-1 ring-inset ring-amber-500/25",
  OWNER:
    "text-[10px] px-2 py-0.5 rounded font-semibold bg-crimson/15 text-crimson ring-1 ring-inset ring-crimson/25",
  ADMIN:
    "text-[10px] px-2 py-0.5 rounded font-semibold bg-blue-500/15 text-blue-700 dark:text-blue-400 ring-1 ring-inset ring-blue-500/25",
  STAFF:
    "text-[10px] px-2 py-0.5 rounded font-semibold bg-muted text-text-secondary ring-1 ring-inset ring-border-subtle",
};
...
export default function ProfilePage() {
  ...
  const [liveClock, setLiveClock] = useState(() =>
    formatClockInTz(user?.timezone ?? "UTC"),
  );
  ...
  if (isMobile)
    return (
      <MobileProfile
        ...
        onActiveSessions={() => router.push("/settings/sessions")}
      />
    );
            ...
            <div className="w-full space-y-3.5 text-left">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-mono text-[11px] text-text-primary leading-tight">
                    {user?.timezone ?? "UTC"}
                  </p>
                </div>
              </div>
              ...
              <CardHeader>
                <div>
                  ...
                  <CardDescription className="mt-0.5">
                    Use a strong password with 8+ characters, including numbers
                    and symbols.
                  </CardDescription>
                </div>
              </CardHeader>
          ...
          <TabsContent value="preferences">
            <Card className="border-0 shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Choose your local timezone. Analytics date filters (Today,
                  This Week, etc.) will use this timezone to compute correct
                  midnight boundaries — ensuring you see data for your actual
              ...
              <CardContent className="space-y-5">
                ...
                <div className="rounded-xl border border-border-subtle bg-muted/30 px-5 py-4">
                  <div className="flex items-center justify-between gap-4">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[12px] text-text-muted font-sans mt-1.5 truncate">
                        {tzLabel}
                      </p>
                    </div>
                    <Clock
                      size={32}
                      weight="thin"
                      className="text-text-muted opacity-30 flex-shrink-0"
                    />
                  </div>
                </div>
                ...
                {browserTz !== tz && (
                  ...
                  >
                    ...
                    Auto-detect: use{" "}
                    <span className="font-mono font-medium">{browserTz}</span>
                  </Button>
                )}
                ...
                <div className="rounded-lg border border-border-subtle bg-muted/30 px-4 py-3 text-[12px] text-text-secondary font-sans leading-relaxed">
                  ...
                  When you select &quot;Today&quot; on the analytics dashboard,
                  the backend will compute midnight in{" "}
                  <strong>{tzLabel}</strong> as the start of day — so you
                  won&apos;t see data from yesterday bleeding in.
                </div>
