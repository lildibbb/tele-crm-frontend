...
function FunnelTooltip({ active, payload }: ChartTooltipProps) {
  if (!active || !payload?.length) return null;
          ...
          {visibleWidgets.map((widget) => {
                    ...
                    {isLoading && !summary ? (
                      ...
                      <>
                        ...
                        <KpiCard
                          ...
                          deltaPositive={
                            (summary?.kpi.contactedLeads.changePercentage ??
                              0) >= 0
                          }
                        />
                        <KpiCard
                          ...
                          deltaPositive={
                            (summary?.kpi.verifiedClients.changePercentage ??
                              0) >= 0
                          }
                          goldValue
                        />
                        <KpiCard
                          ...
                          deltaPositive={
                            (summary?.kpi.formSubmissions.changePercentage ??
                              0) >= 0
                          }
                        />
                      </>
            ...
            if (widget.id === "funnel-activity")
              return (
                ...
                <div
                  key="funnel-activity"
                  className="page-section grid grid-cols-1 xl:grid-cols-7 gap-3 md:gap-4"
                >
                  {/* Funnel Donut Chart */}
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex flex-col items-end gap-1 flex-shrink-0">
                                <Badge
                                  className={`badge text-[10px] ${badge.cls}`}
                                >
                                  {t(badge.labelKey)}
                                </Badge>
            ...
            if (widget.id === "action-strip")
              return (
                ...
                <div
                  key="action-strip"
                  className="page-section bg-elevated rounded-xl overflow-hidden border border-border-subtle shadow-sm"
                >
            ...
            if (widget.id === "trend-charts")
              return (
                ...
                <div
                  key="trend-charts"
                  className="page-section grid grid-cols-1 xl:grid-cols-5 gap-3 md:gap-4"
                >
